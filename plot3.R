...
with(hpc2, plot(Date3,Sub_metering_1, type = "n",xlab="",ylab="Energy sub metering"))
with(hpc2,lines(Date3, Sub_metering_1))
with(hpc2,lines(Date3, Sub_metering_2,col="red"))
with(hpc2,lines(Date3, Sub_metering_3,col="blue"))
